...
if __name__ == "__main__":
    ...
    for K in Ks:
        ...
        for jidx in range(len(Js)):
            ...
            for algo in algorithms:
                ...
                time_alljsigma_fig.add_trace(go.Box(
                    y=runtimes, showlegend=True, name=r'{}\\\J={},sigma_e^2={}'.format(plotname, J, sigma_e),
                ...
                ram_avg_alljsigma_fig.add_trace(go.Box(
                    y=ram["avg"], showlegend=True, name=r'{}-avg\\\J={},sigma_e^2={}'.format(plotname, J, sigma_e),
                    boxpoints='outliers', opacity=1-0.2*sigma_es.index(sigma_e), line=dict(color=colors[algo]),                                
                ))
                ...
                cpu_avg_alljsigma_fig.add_trace(go.Box(
                    y=cpu_util["avg"], showlegend=True, name=r'{}-avg\\J={},\sigma_e^2={}'.format(plotname, J, sigma_e),
                    boxpoints='outliers', opacity=1-0.2*sigma_es.index(sigma_e), line=dict(color=colors[algo]),                                
                ))
                ...
                for param in parameter_names:
                    if param in ["X", "Z"]:
                        param_alljsigma_err_fig[param].add_trace(go.Box(
                            y=theta_err[param], showlegend=True, name=r'{}\\J={},\sigma_e^2={}'.format(plotname, J, sigma_e),
                            boxpoints='outliers', opacity=1-0.2*sigma_es.index(sigma_e), line=dict(color=colors[algo])                          
                        ))
                        ...
                        param_alljsigma_err_fig["{}_RT".format(param)].add_trace(go.Box(
                            y=theta_err_RT[param], showlegend=True, name=r'{}\\J={},\sigma_e^2={}'.format(plotname, J, sigma_e),
                            boxpoints='outliers', opacity=1-0.2*sigma_es.index(sigma_e), line=dict(color=colors[algo])                          
                        ))
        ...
        fix_plot_layout_and_save(time_alljsigma_fig, savename, xaxis_title=r'Estimation algorithm, $J, \sigma_e^2$', yaxis_title="Duration (in minutes)", title="", 
                                showgrid=False, showlegend=False, 
                                print_png=True, print_html=False, 
                                print_pdf=False)     
        fix_plot_layout_and_save(time_alljsigma_fig, savename, xaxis_title=r'Estimation algorithm, $J, \sigma_e^2$', yaxis_title="Duration (in minutes)", title="", 
        ...
        fix_plot_layout_and_save(ram_avg_alljsigma_fig, savename, xaxis_title=r'Estimation algorithm, $J, \sigma_e^2$', yaxis_title="Average RAM consumption (in GB)", title="", 
                                showgrid=False, showlegend=False, 
                                print_png=True, print_html=False, 
                                print_pdf=False) 
        fix_plot_layout_and_save(ram_avg_alljsigma_fig, savename, xaxis_title=r'Estimation algorithm, $J, \sigma_e^2$', yaxis_title="Average RAM consumption (in GB)", title="", 
        ...
        fix_plot_layout_and_save(cpu_avg_alljsigma_fig, savename, xaxis_title=r'Estimation algorithm, $J, \sigma_e^2$', yaxis_title="Maximum CPU utilisation (% usage of 1 core)", title="", 
                                showgrid=False, showlegend=False, 
                                print_png=True, print_html=False, 
                                print_pdf=False) 
        fix_plot_layout_and_save(cpu_avg_alljsigma_fig, savename, xaxis_title=r'Estimation algorithm, $J, \sigma_e^2$', yaxis_title="Maximum CPU utilisation (% usage of 1 core))", title="", 
        ...
        for param in parameter_names:
            ...
            if param in ["X", "Z"]:
                ...
                fix_plot_layout_and_save(param_alljsigma_err_fig["{}_RT".format(param)], 
                                    savename, xaxis_title=r'Estimation algorithm, $J,\sigma_e^2$', 
                                    yaxis_title="Mean relative error (under rotation/scaling)", 
                                    title="", showgrid=False, showlegend=False, 
                                    print_png=True, print_html=False, 
                                    print_pdf=False) 
                fix_plot_layout_and_save(param_alljsigma_err_fig["{}_RT".format(param)], 
                                    ...
                                    print_pdf=False) 
            savename = "{}/rel_err_{}_K{}_J{}_allsigmae.html".format(dir_out, param, K, J)
            fix_plot_layout_and_save(param_alljsigma_err_fig[param], savename, xaxis_title=r'Estimation algorithm, $J,\sigma_e^2$', 
