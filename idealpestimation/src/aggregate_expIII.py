...
if __name__ == "__main__":
    ...
    for algo in algorithms:
        ...
        for K in Ks:
            ...
            time_alljsigma_fig = make_subplots(specs=[[{"secondary_y": False}]])#True}]])
            param_alljsigma_err_fig = {}
            for param in parameter_names:
                if param in ["X", "Z"]:
                    param_alljsigma_err_fig["{}_RT".format(param)] = go.Figure()
                param_alljsigma_err_fig[param] = go.Figure()
            for jidx in range(len(Js)):
                J = Js[jidx]
                sigma_e = sigma_es[jidx]
                batchsize = batchsizes[jidx]
                ...
                for algo_inner in [algo]: #rithms:
                    ...
                    #     y=runtimes, showlegend=True, name=r"${{{plotname}}}, J={{{J}}},\sigma_e^2={{{sigma_e}}}$".format(plotname=plotname, J=J, sigma_e=sigma_e),
                    #     boxpoints='outliers', opacity=1-0.2*sigma_es.index(sigma_e), line=dict(color=colors[algo]),                                
                    # ), secondary_y=sec_y)
                    time_alljsigma_fig.add_trace(go.Box(
                        y=runtimes, showlegend=True, name=r"$J={{{J}}},\sigma_e^2={{{sigma_e}}}$".format(J=J, sigma_e=sigma_e),
                        boxpoints='outliers', opacity=1, line=dict(color=colors[algo]),                                
                    ), secondary_y=sec_y)
                    ...
                    #     y=ram["avg"], showlegend=True, name=r"${{{plotname}}}-avg, J={{{J}}},\sigma_e^2={{{sigma_e}}}$".format(plotname=plotname, J=J, sigma_e=sigma_e),
                    #     boxpoints='outliers', opacity=1-0.2*sigma_es.index(sigma_e), line=dict(color=colors[algo]),                                
                    # ))
                    ram_avg_alljsigma_fig.add_trace(go.Box(
                        y=ram["avg"], showlegend=True, name=r"$J={{{J}}},\sigma_e^2={{{sigma_e}}}$".format(J=J, sigma_e=sigma_e),
                        boxpoints='outliers', opacity=1, line=dict(color=colors[algo]),                                
                    ))
                    ...
                    #     y=cpu_util["avg"], showlegend=True, name=r"${{{plotname}}}-avg, J={{{J}}},\sigma_e^2={{{sigma_e}}}$".format(plotname=plotname, J=J, sigma_e=sigma_e),
                    #     boxpoints='outliers', opacity=1-0.2*sigma_es.index(sigma_e), line=dict(color=colors[algo]),                                
                    # ))
                    cpu_avg_alljsigma_fig.add_trace(go.Box(
                        y=cpu_util["avg"], showlegend=True, name=r"$J={{{J}}},\sigma_e^2={{{sigma_e}}}$".format(J=J, sigma_e=sigma_e),
                        boxpoints='outliers', opacity=1, line=dict(color=colors[algo]),                                
                    ))
                    ...
                    for param in parameter_names:
                        if param in ["X", "Z"]:
                            ...
                            #     y=np.asarray(theta_err[param])/parameter_space_dim, showlegend=True, name=r"${{{plotname}}}, J={{{J}}},\sigma_e^2={{{sigma_e}}}$".format(plotname=plotname, J=J, sigma_e=sigma_e),
                            #     boxpoints='outliers', opacity=1-0.2*sigma_es.index(sigma_e), line=dict(color=colors[algo])                          
                            # ))
                            param_alljsigma_err_fig[param].add_trace(go.Box(
                                y=np.asarray(theta_err[param])/parameter_space_dim, showlegend=True, name=r"$J={{{J}}},\sigma_e^2={{{sigma_e}}}$".format(J=J, sigma_e=sigma_e),
                                boxpoints='outliers', opacity=1, line=dict(color=colors[algo])                          
                            ))
                            ...
                            #     y=np.asarray(theta_err_RT[param])/parameter_space_dim, showlegend=True, name=r"${{{plotname}}}, J={{{J}}},\sigma_e^2={{{sigma_e}}}$".format(plotname=plotname, J=J, sigma_e=sigma_e),
                            #     boxpoints='outliers', opacity=1-0.2*sigma_es.index(sigma_e), line=dict(color=colors[algo])                          
                            # ))
                            param_alljsigma_err_fig["{}_RT".format(param)].add_trace(go.Box(
                                y=np.asarray(theta_err_RT[param])/parameter_space_dim, showlegend=True, name=r"$J={{{J}}},\sigma_e^2={{{sigma_e}}}$".format(J=J, sigma_e=sigma_e),
                                boxpoints='outliers', opacity=1, line=dict(color=colors[algo])                          
                            ))
                    ...
                    for param in parameter_names:
                        ...
                        fix_plot_layout_and_save(param_sqerr_fig[param], savename, xaxis_title="Estimation algorithm", yaxis_title="Mean relative squared error", title="", 
                                            ...
                                            print_png=False, print_html=True, 
                                            print_pdf=False) 
            savename = "{}/time_K{}_J{}_alljsigmae.html".format(dir_out, K, J)    
            time_alljsigma_fig.update_yaxes(title_text="Duration (in seconds), D-MLE, CA", secondary_y=True)
            fix_plot_layout_and_save(time_alljsigma_fig, savename, xaxis_title=r'$\text{J, }\sigma_e^2$', yaxis_title="Duration (in minutes)", title="", 
                                    showgrid=False, showlegend=False, 
                                    print_png=True, print_html=True, 
                                    print_pdf=True)     
            # fix_plot_layout_and_save(time_alljsigma_fig, savename, xaxis_title=r'$\text{Estimation algorithm, J, }\sigma_e^2$', yaxis_title="Duration (in minutes)", title="", 
            #                         showgrid=False, showlegend=True, 
            #                         print_png=False, print_html=True, 
            #                         print_pdf=False) 
            savename = "{}/ram_avg_K{}_J{}_allsigmae.html".format(dir_out, K, J)    
            fix_plot_layout_and_save(ram_avg_alljsigma_fig, savename, xaxis_title=r'$\text{J, }\sigma_e^2$', yaxis_title="Average RAM consumption (in GB)", title="", 
                                    showgrid=False, showlegend=False, 
                                    print_png=True, print_html=True, 
                                    print_pdf=True) 
            # fix_plot_layout_and_save(ram_avg_alljsigma_fig, savename, xaxis_title=r'$\text{Estimation algorithm, J, }\sigma_e^2$', yaxis_title="Average RAM consumption (in GB)", title="", 
            #                         showgrid=False, showlegend=True, 
            #                         print_png=False, print_html=True, 
            #                         print_pdf=False) 
            savename = "{}/cpu_avg_K{}_J{}_allsigmae.html".format(dir_out, K, J)    
            fix_plot_layout_and_save(cpu_avg_alljsigma_fig, savename, xaxis_title=r'$\text{J, }\sigma_e^2$', yaxis_title="Max CPU utilisation (% usage of 1 core)", title="", 
                                    showgrid=False, showlegend=False, 
                                    print_png=True, print_html=True, 
                                    print_pdf=True) 
            # fix_plot_layout_and_save(cpu_avg_alljsigma_fig, savename, xaxis_title=r'$\text{Estimation algorithm, J, }\sigma_e^2$', yaxis_title="Maximum CPU utilisation (% usage of 1 core))", title="", 
            #                         showgrid=False, showlegend=True, 
            #                         print_png=False, print_html=True, 
            #                         print_pdf=False) 
            for param in parameter_names:
                ...
                if param in ["X", "Z"]:
                    ...
                    fix_plot_layout_and_save(param_alljsigma_err_fig["{}_RT".format(param)], 
                                        savename, xaxis_title=r'$\text{J, }\sigma_e^2$', 
                                        yaxis_title="Mean relative error (under rotation/scaling)", 
                                        title="", showgrid=False, showlegend=False, 
                                        print_png=True, print_html=True, 
                                        print_pdf=True) 
                    # fix_plot_layout_and_save(param_alljsigma_err_fig["{}_RT".format(param)], 
                    #                     savename, xaxis_title=r'$\text{Estimation algorithm, J,}\sigma_e^2$', 
                    #                     yaxis_title="Mean relative error (under rotation/scaling)", 
                    #                     title="", showgrid=False, showlegend=True, 
                    #                     print_png=False, print_html=True, 
                    #                     print_pdf=False) 
                savename = "{}/rel_err_{}_K{}_J{}_allsigmae.html".format(dir_out, param, K, J)
                fix_plot_layout_and_save(param_alljsigma_err_fig[param], savename, xaxis_title=r'$\text{J, }\sigma_e^2$', 
                                    yaxis_title="Mean relative error", title="", 
                                    showgrid=False, showlegend=False, 
                                    print_png=True, print_html=True, 
                                    print_pdf=True)    
                # fix_plot_layout_and_save(param_alljsigma_err_fig[param], savename, xaxis_title=r'$\text{Estimation algorithm, J,}\sigma_e^2$', 
                #                     yaxis_title="Mean relative error", title="", 
                #                     showgrid=False, showlegend=True, 
                #                     print_png=False, print_html=True, 
                #                     print_pdf=False) 
