        ...
        for jidx in range(len(Js)):
            ...
            for algo in algorithms:
                ...
                time_alljsigma_fig.add_trace(go.Box(
                    y=runtimes, showlegend=True, name=r'{} '.format(plotname) + r'$J={},\sigma_e^2={}$'.format(J, sigma_e),
                ...
                ram_avg_alljsigma_fig.add_trace(go.Box(
                    y=ram["avg"], showlegend=True, name=r'{}-avg '.format(plotname) + r'$J={},sigma_e^2={}$'.format(J, sigma_e),
                    boxpoints='outliers', opacity=1-0.2*sigma_es.index(sigma_e), line=dict(color=colors[algo]),                                
                ))
                ...
                cpu_avg_alljsigma_fig.add_trace(go.Box(
                    y=cpu_util["avg"], showlegend=True, name=r'{}-avg '.format(plotname) + r'$J={},\sigma_e^2={}$'.format(J, sigma_e),
                    boxpoints='outliers', opacity=1-0.2*sigma_es.index(sigma_e), line=dict(color=colors[algo]),                                
                ))
                ...
                for param in parameter_names:
                    if param in ["X", "Z"]:
                        param_alljsigma_err_fig[param].add_trace(go.Box(
                            y=theta_err[param], showlegend=True, name=r'{} '.format(plotname) + r'$J={},\sigma_e^2={}$'.format(J, sigma_e),
                            boxpoints='outliers', opacity=1-0.2*sigma_es.index(sigma_e), line=dict(color=colors[algo])                          
                        ))
                        ...
                        param_alljsigma_err_fig["{}_RT".format(param)].add_trace(go.Box(
                            y=theta_err_RT[param], showlegend=True, name=r'{} '.format(plotname) + r'$J={},\sigma_e^2={}$'.format(J, sigma_e),
                            boxpoints='outliers', opacity=1-0.2*sigma_es.index(sigma_e), line=dict(color=colors[algo])                          
                        ))
